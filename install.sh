...
echo -e "${BLUE}───────────────────────────────────────────────────────────────${NC}"
echo ""
echo "Right now, your activities go into activity/raw/ as plain JSON."
echo ""
echo "Want daily summaries? Add your API key to $INSTALL_DIR/.env:"
echo ""
echo "  ANTHROPIC_API_KEY=sk-ant-..."
echo ""
echo "Then Cárdenas can generate narrative summaries of each day."
echo "(There's also a nightly job option, but that's more advanced.)"
echo ""
